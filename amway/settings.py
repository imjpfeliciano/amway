...
ADMINS = (
        ('Jonathan Peraza Feliciano', 'jperazafeliciano@gmail.com'),
)
...
#'NAME': '/ruta_del_directorio_del_proyecto/amway/amway.db',
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'atheaDatabase.db',          # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'amway.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'amway.wsgi.application'
